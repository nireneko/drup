...
- `project_path`
- The `autofix` MCP contract accepts only `project_path`; it discovers the native custom module/theme paths itself. Never send `target_paths`.
...
Every mutating MCP call includes a stable, fresh `request_id` supplied in the dispatch.
...
{
  "schema_version": "v1",
  "identity": {"root": "...", "candidate": "...", "run_id": "...", "phase": "rector"},
  "agent": "drup-rector",
