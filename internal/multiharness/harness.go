...
func Corpus() []Scenario {
	return []Scenario{
		...
		{Name: "dirty-tree", Dispatch: fixtureDispatch("drup-preflight", "preflight", "env"), Report: fixtureReport("drup-preflight", "preflight", "blocked"), Calls: []ToolCall{{Name: "composer_require", Arguments: json.RawMessage(`{"project_path":"/project","package":"drupal/upgrade_status","run_id":"run-fixture","request_id":"dirty-tree-1"}`)}}, WantBlocked: true},
		{Name: "backup-failure", Dispatch: fixtureDispatch("drup-preflight", "backup", "backup"), Report: fixtureReport("drup-preflight", "backup", "blocked"), Calls: []ToolCall{{Name: "test_backup_create", Arguments: json.RawMessage(`{"project_path":"/project","run_id":"run-fixture","request_id":"backup-failure-1"}`)}}, WantBlocked: true},
		...
		{Name: "contrib-major-isolated", Dispatch: fixtureDispatch("drup-contrib", "contrib", "contrib"), Report: fixtureReport("drup-contrib", "contrib", "pass"), Calls: []ToolCall{{Name: "composer_require", Arguments: json.RawMessage(`{"project_path":"/project","package":"drupal/example:^3","run_id":"run-fixture","request_id":"contrib-major-1"}`)}}},
		{Name: "core-sequential", Dispatch: fixtureDispatch("drup-contrib", "core", "core"), Report: fixtureReport("drup-contrib", "core", "pass"), Calls: []ToolCall{{Name: "core_upgrade_apply", Arguments: json.RawMessage(`{"project_path":"/project","target_major":11,"run_id":"run-fixture","request_id":"core-11"}`)}, {Name: "core_upgrade_apply", Arguments: json.RawMessage(`{"project_path":"/project","target_major":12,"run_id":"run-fixture","request_id":"core-12"}`)}}},
		{Name: "confirmation-rejected", Dispatch: fixtureDispatch("drup-contrib", "core", "core"), Report: fixtureReport("drup-contrib", "core", "blocked"), Calls: []ToolCall{{Name: "core_upgrade_apply", Arguments: json.RawMessage(`{"project_path":"/project","target_major":11,"run_id":"run-fixture","request_id":"confirmation-rejected-1"}`)}}, WantBlocked: true},
		{Name: "ambiguous-restart-requires-recovery", Dispatch: fixtureDispatch("drup-contrib", "contrib", "contrib"), Report: fixtureReport("drup-contrib", "contrib", "pass"), Calls: []ToolCall{{Name: "apply_patch", Arguments: json.RawMessage(`{"project_path":"/project","patch_url":"https://example.test/fix.patch","composer_package":"drupal/example","description":"retry only after reconciliation","run_id":"run-fixture","request_id":"ambiguous-1"}`), Unknown: true}}, WantBlocked: true},
	}
}
