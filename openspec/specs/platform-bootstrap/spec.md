...
Templates for generating platform-specific bootstrap files and a cross-platform SKILL.md for AI agents (Claude Code, OpenCode, Codex). Bootstrap files instruct the AI to load and follow SKILL.md, which encodes the full upgrade pipeline.
